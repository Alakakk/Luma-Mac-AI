...
contextBridge.exposeInMainWorld('luma', {
  ...
  aiSaveSettings: (value) => ipcRenderer.invoke('ai:save-settings', value),
  aiModels: (value) => ipcRenderer.invoke('ai:models', value),
  aiTest: (value) => ipcRenderer.invoke('ai:test', value),
  aiChat: (value) => ipcRenderer.invoke('ai:chat', value),
  aiDictation: () => ipcRenderer.invoke('ai:dictation'),
  aiPanel: (value) => ipcRenderer.invoke('window:ai-panel', value),
